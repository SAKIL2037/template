    ...
    <div id="user_login_holder_<?php print $params['id'] ?>">
        ...
        <form method="post" id="user_login_<?php print $params['id'] ?>" action="#" autocomplete="off">
            ...
            <div class="form-group">
                <input class="form-control input-lg" type="text" name="username" placeholder="<?php _lang("Benutzername oder E-Mail-Adresse", "templates/electron"); ?>">
            </div>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <p class="login-pass"><a href="<?php print forgot_password_url(); ?>"><?php _lang("Passwort vergessen ?", "templates/electron"); ?></a></p>
                </div>
            </div>

            <button type="submit" class="btn btn-default btn-lg btn-block m-t-10"><?php _lang("Einloggen", "templates/electron"); ?></button>
        </form>
