...
if (isset($_GET['wishlist_id'])) {
    ...
    <input onClick="this.select();" type="text" class="form-control" id="input_text" >
            ...
            <div class="product-single">
                ...
                <div class="post-info">
                    ...
                    <?php if ($show_fields == false or in_array('title', $show_fields)): ?>
                        <div class="">
                            <h2 itemprop="name" class=""><a itemprop="url" class="lead" href="<?php print $item['link'] ?>"><?php print character_limiter($item['title'], 22) ?></a></h2>
                        </div>
                    <?php endif; ?>
